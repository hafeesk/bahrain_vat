...
def execute(filters=None):
	...
	data = [[lst_description[0],sales_data[0][0],sales_data[0][1]],[lst_description[1],zero_sales_data[0][0],0.00],[lst_description[2],sales_data[0][0],sales_data[0][1]],[lst_description[3],purchase_data[0][0],purchase_data[0][1]],[lst_description[4],zero_purchase_data[0][0],0.00],[lst_description[5],sales_data[0][0]+purchase_data[0][0],sales_data[0][1]+purchase_data[0][1]]]
